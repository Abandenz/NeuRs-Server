...
public final class Report implements PacketType {
     ...
     *
     * @param username The name of the client who spoke.
     * @param text     The message (what they said) in {@link byte}-form.
     ...
     *
     * @param b Whether it's for the document name or not (true = document).
    ...
    private static final class ChatMessage {
         ...
         *
         * @param name    The name of the {@link Client} that spoke.
