                ...
                for (int i = 0; i < Config.MAX_PLAYERS; i++) {
                    if (PlayerHandler.players[i] != null) {
                        if (PlayerHandler.players[i].playerName.equalsIgnoreCase(giveDonor)) {
                            PlayerHandler.players[i].memberStatus = 2;
                            c.sendMessage("You have made made" + PlayerHandler.players[i].playerName + " an [@gre@Donator]");
                        }
                    }
                }
            } catch (Exception e) {
                ...
                for (int i = 0; i < Config.MAX_PLAYERS; i++) {
                    if (PlayerHandler.players[i] != null) {
                        if (PlayerHandler.players[i].playerName.equalsIgnoreCase(giveDonor)) {
                            ...
                            PlayerHandler.players[i].memberStatus = 0;
                            c.sendMessage("@red@You have demoted " + PlayerHandler.players[i].playerName + ".");
                        }
                    }
                }
            } catch (Exception e) {
                ...
                for (int i = 0; i < Config.MAX_PLAYERS; i++) {
                    if (PlayerHandler.players[i] != null) {
                        if (PlayerHandler.players[i].playerName.equalsIgnoreCase(giveDonor)) {
                            ...
                            c.sendMessage("You have made made" + PlayerHandler.players[i].playerName + " an [@blu@Moderator]");
                        }
                    }
                }
            } catch (Exception e) {
                ...
                for (int i = 0; i < Config.MAX_PLAYERS; i++) {
                    if (PlayerHandler.players[i] != null) {
                        if (PlayerHandler.players[i].playerName.equalsIgnoreCase(giveDonor)) {
                            ...
                            c.sendMessage("You have made made" + PlayerHandler.players[i].playerName + " an [@cya@Admin]");
                        }
                    }
                }
            } catch (Exception e) {
                ...
                for (int i = 0; i < Config.MAX_PLAYERS; i++) {
                    if (PlayerHandler.players[i] != null) {
                        if (PlayerHandler.players[i].playerName.equalsIgnoreCase(giveDonor)) {
                            ...
                            c.sendMessage("You have made made" + PlayerHandler.players[i].playerName + "an [@dre@owner]");
                        }
                    }
                }
            } catch (Exception e) {
        ...
        if (playerCommand.startsWith("givespawn") && c.playerRights >= 3) {
            try {
                ...
                for (int i = 0; i < Config.MAX_PLAYERS; i++) {
                    if (PlayerHandler.players[i] != null) {
                        if (PlayerHandler.players[i].playerName.equalsIgnoreCase(giveDonor)) {
                            PlayerHandler.players[i].memberStatus = 3;
                            c.sendMessage("The player" + PlayerHandler.players[i].playerName + "is able to spawn.");
                        }
                    }
                }
            } catch (Exception e) {
                ...
                for (int i = 0; i < Config.MAX_PLAYERS; i++) {
                    if (PlayerHandler.players[i] != null) {
                        if (PlayerHandler.players[i].playerName.equalsIgnoreCase(playerToBan)) {
                            ...
                            c.sendMessage("@red@You have Un Ip-Muted the user: " + PlayerHandler.players[i].playerName);
                            break;
                        }
                    }
                }
